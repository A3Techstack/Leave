...
<?php
	...
	if (isset($_POST['btnUserLeaveApplicationUpdate']))
	{
		...
		$objLeaveApplication = new LeaveApplication();
		$objLeaveApplication->updateOnesApplicattion($livUserId,$livUserLeaveFrom,$livUserLeaveTo,$livUserLeaveType,$lTotalLeaveDays,$lTotalLeaveDaysRemain,$livEmpReason,$livApplicationUpdateBy);
