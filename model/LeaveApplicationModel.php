...
<?php
	...
	class LeaveApplication extends DbOperation
	{
		...
		function getLeaveForRecomandation()
		{
			...
			$columnsName = "ld.lType, emp.eFirstName,liv.lEmployeeCodeNumberWhoApply,emp.eLastName,liv.lId,liv.lApplyDate,liv.lTotalLeaveDays,liv.lLeaveFromDate,liv.lLeaveToDate,liv.lTotalLeaveDaysRemain,liv.lLeaveReason";
			//database column name
		...
		function getRecomandedApplication()
		{
			...
			$columnsName = "ld.lType,emp.eFirstName,emp.eLastName,liv.lId,liv.lApplyDate,liv.lTotalLeaveDays,liv.lLeaveFromDate,liv.lLeaveToDate,liv.lTotalLeaveDaysRemain,liv.lLeaveReason";
			//database column name
			$tablesName = "employeeleaveapplicationdetails liv INNER JOIN employeeinfo emp ON liv.lEmployeeCodeNumberWhoApply = emp.eEmployeeCodeNumber INNER JOIN leavedetails ld ON liv.lLeaveId = ld.lId";
			//database table name
