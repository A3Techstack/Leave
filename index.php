                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                            		...
                            		<p>Login to Leave Application</p>
                        		</div>
										...
										?>
											<form role="form" action="controller/LoginController.php" method="post" class="login-form">
												<div class="form-group">
													<label class="sr-only" for="form-username">Employee Code</label>
													<input type="text" name="officeUserCode" placeholder="Employee Code" class="form-username form-control" id="form-username">
												</div>
												<div class="form-group">
												...
												<h3 align="center">Incorrect Employee code Or Password</h3>
