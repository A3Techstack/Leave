								...
								<tbody>
									...
									if(isset($applicantUserCodeNumber))
									{
										...
										else
										{
											?>
												<tr>
													<td colspan="5"><center><b style="color:red; font-size: 20px;"><i>" This user have not applied for leave "</i></b></center></td>
												</tr>
											<?php
										}
									}
									else
									{
										?>
											<tr>
												<td colspan="5"><center><b style="color:Blue; font-size: 20px;"><i>" <a href="../view/ListEmployee.php">You Need</a> to select a user to view details "</i></b></center></td>
											</tr>
										<?php
									}
										?>
