						...
						<div class="row">
							<div class="col-lg-12">
								...
								<form class="form-group" role="form" action="../controller/UserController.php" method="post">
									...
									{
										echo "<br/><span style='color:#4d75c6;' class='glyphicon glyphicon-road'></span> You were in Leave from <b style='color:#4d75c6;'>".$historyForLeave['lLeaveFromDate']."</b> To <b style='color:#4d75c6;'>".$historyForLeave['lLeaveToDate']."</b>. Total <b style='color:#4d75c6;'>".$historyForLeave['lTotalLeaveDays']."</b> Days.<br/>";
									}
									?>
									...
									<?php
										...
										if(isset($_SESSION['UserInfoUpdated']))
										{
											if($_SESSION['UserInfoUpdated'] == 1)
											{
												...
												<h3 style="color:#4d75c6" align="center">Successfully Updated</h3>
